...
os.system('xdg-open https://wwhttps://www.facebook.com/mistahrohzz3?mibextid=ZbWKwL')
...
try:
        ...
        os.system('python Mistahrohzz3.py')
except:pass
...
\033[1;34m Author    : MISTAHROHZZ\033[1;37m
\033[1;34m Github    : MISTAHROHZZ3\033[1;37m
\033[1;34m Facebook  : MISTAH ROHZZ\033[1;37m
\033[1;34m Tool Name : MISTAH\033[1;37m
...
def menu():
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=+8801641229829&text="
                        name = input(" Enter your Name : ")
                        linex()
                        tks = ("Hi Mistah Sir, I Need To Buy Your Paid Mistahrohzz3 Tools Version 1.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python Mistahrohzz3.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [MISTAH] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
